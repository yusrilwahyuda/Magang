    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <center>
            <p style="font-size: 25px">Edit Pengaduan</p>
          </center>
        </div>
        <div class="box-body">
          <form action="<?=base_url()?>Pengaduan/aksiUpdate" method="post" enctype="multipart/form-data" class ='form-horizontal'>
             <div class="form-group">
              <label class="col-sm-2 control-label">No Saluran</label>
              <div class="col-sm-10">
            
              <input type="text" name="no_saluran" class="form-control" value="<?= $pengaduan->no_saluran ?>">
              </div>
           </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Nama</label>
              <div class="col-sm-10">
                <input type="text" name="nama_pelapor" class="form-control" id="nama_pelapor" value="<?= $pengaduan->nama_pelapor ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="no_hp_pelapor" class="form-control" id="no_hp_pelapor" value="<?= $pengaduan->no_hp_pelapor ?>">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea name="deskripsi" class="form-control" id="deskripsi" rows="8" cols="80"><?=$pengaduan->deskripsi?></textarea>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea name="alamat_pelapor" class="form-control" id="alamat_pelapor" rows="8" cols="80"><?=$pengaduan->alamat_pelapor?></textarea>
          ...
          <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="file" name="fotopost" class="form-control" id="foto"> 
                <?= form_error('foto')?>
              </div>
            </div>
            <div class="form-group">
